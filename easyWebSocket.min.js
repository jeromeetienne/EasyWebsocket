...
EasyWebSocket.prototype._sioCtor=function(){var a=this,b=this.parseUri(EasyWebSocket.serverUrl),c=b.host;b=parseInt(b.port);WEB_SOCKET_SWF_LOCATION="http://easywebsocket.org/node/server/node_modules/socket.io/support/socket.io-client/lib/vendor/web-socket-js/WebSocketMain.swf";this._sockio=new io.Socket(c,{port:b,rememberTransport:false,transports:["websocket","htmlfile","xhr-multipart","xhr-polling"]});this._sockio.connect();this._sockio.on("connect",function(){a.log("socket connected",a._sockio,
